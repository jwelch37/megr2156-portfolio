...
To begin my parametric design of the hollow bar, I needed to choose and define multiple variables. These variables would allow me to solve for the bars length. First, I chose my axial load to be 450lbf from the range of 300lbf < F < 500lbf. Next I needed to choose an aluminum alloy in SolidWorks to get a defined elastic modulus. The max axial deflection of the bar is given as 0.009 in.   

<img src="aluminum.png" alt="Alt Text" width="40%">  

I chose 1345 alloy, this decision was essentially random.  
